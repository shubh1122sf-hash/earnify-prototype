...
export default function LoginPage() {
  ...
  useEffect(() => {
    // If loading is finished and we have a user, they don't need to be here.
    if (!loading && user) {
      router.push('/');
    }
  }, [user, loading, router]);
  
  // While checking for user, or if user exists, show a loading screen.
  ...
  const handleSignIn = async () => {
    try {
      ...
      // No navigation here. The AuthProvider and AppLayout will handle it.
    } catch (error) {
