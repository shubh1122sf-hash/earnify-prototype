...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 48 48">
    ...
    <path
      fill="#1976D2"
      d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.99,35.08,44,28.891,44,20C44,22.659,43.862,21.35,43.611,20.083z"
    />
  </svg>
);
...
export default function LoginPage() {
  ...
  // This check prevents a flash of the login page for already authenticated users
  if (user) {
    return (
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="flex flex-col items-center gap-4">
